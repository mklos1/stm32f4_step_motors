...
void gpio_init(void) {
	...
	GPIO_InitDef.GPIO_Pin = DIR_SER_PIN | DIR_LATCH_PIN | DIR_EN_PIN | PWM2A_PIN;
	GPIO_Init(GPIOA, &GPIO_InitDef);

	GPIO_InitDef.GPIO_Pin = DIR_CLK_PIN | PWM0A_PIN | PWM0B_PIN | PWM1B_PIN | PWM2B_PIN;
	GPIO_Init(GPIOB, &GPIO_InitDef);

	GPIO_InitDef.GPIO_Pin = PWM1A_PIN;
